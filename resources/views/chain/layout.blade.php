...
<head>
    ...
    <style>
        :root{color-scheme:dark}.theme-light{color-scheme:light}.theme-light body{background:#f7f7f8!important;color:#18181b!important}.theme-light .bg-slate-950{background-color:#fafafa!important}.theme-light .bg-slate-950\/50{background-color:#fafafa!important}.theme-light .bg-slate-900,.theme-light .bg-slate-900\/70{background-color:#fff!important}.theme-light .bg-slate-800{background-color:#f4f4f5!important}.theme-light .border-slate-800,.theme-light .border-slate-700{border-color:#e4e4e7!important}.theme-light .text-slate-100,.theme-light .text-white{color:#18181b!important}.theme-light .text-slate-400{color:#52525b!important}.theme-light .text-slate-500,.theme-light .text-slate-600{color:#71717a!important}.theme-light input,.theme-light select,.theme-light textarea{color:#18181b!important}.theme-light .dark-logo{display:none}.theme-dark .light-logo{display:none}.theme-light .nav-active{background:#18181b!important;color:#fff!important}.theme-dark .nav-active{background:#f4f4f5!important;color:#18181b!important}.theme-light .nav-active-dot{background:#fff!important}.theme-dark .nav-active-dot{background:#18181b!important}.nav-link{letter-spacing:-.01em}.panel-shadow{box-shadow:0 12px 30px rgba(0,0,0,.08)}.rounded-2xl{border-radius:.75rem!important}.rounded-xl{border-radius:.625rem!important}::selection{background:#a7f3d0;color:#064e3b}
    </style>
</head>
...
<div class="flex min-h-screen">
    ...
    <main class="min-w-0 flex-1">
        <header class="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-800 bg-slate-950/80 px-4 backdrop-blur-xl lg:px-7">
