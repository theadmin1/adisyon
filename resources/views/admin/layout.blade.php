    ...
    <div class="flex flex-1">
        ...
        <aside class="w-64 bg-[#141620] border-r border-gray-800 p-4 space-y-6 flex flex-col">
            ...
            <nav class="space-y-1 flex-1">
                ...
                <a href="{{ route('admin.chains.index') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition {{ request()->routeIs('admin.chains.*') || request()->routeIs('admin.chain-users.*') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-600/30' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <i class="fa-solid fa-building w-5 text-center"></i>
                    <span>🏢 Zincir Yönetimi</span>
                </a>
