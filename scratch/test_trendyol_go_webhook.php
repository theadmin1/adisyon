...
echo "==========================================================" . PHP_EOL;
echo "🛵 TRENDYOL GO CANLI SİPARİŞ & WEBHOOK ENTEGRASYON TESTİ" . PHP_EOL;
echo "==========================================================" . PHP_EOL;

$controller = new \App\Http\Controllers\Api\TrendyolGoController(new \App\Services\TrendyolGoService());
$request = \Illuminate\Http\Request::create('/api/v1/integrations/trendyol-go/test-order', 'POST');
...
// Veritabanı Kontrolü
$latestOrder = \App\Models\DeliveryOrder::on('sqlite')->where('channel', 'trendyol')->latest()->first();
if ($latestOrder) {
    echo PHP_EOL . "✅ VERİTABANI DOĞRULAMA BAŞARILI!" . PHP_EOL;
